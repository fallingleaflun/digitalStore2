...
<script>
	...
	function changeProductNum(count, totalCount, id) {
		...
		location.href = "${pageContext.request.contextPath}/changeCart?id="
				+ id + "&count=" + count;//这里会通过url传参，跳转到ChangeCartServlet来实现对购物车商品的修改
	}
	//删除购物车中的商品
	function cart_del() {   
	    var msg = "您确定要删除该商品吗？";   
													...
													<tr>
														...
														<td width="20%">
															...
															<input type="button" value='-' style="width:20px"
															       onclick="changeProductNum('${entry.value-1}','${entry.key.remain}','${entry.key.id}')">
															 <!-- 商品数量显示 -->
														...
														<td width="10%">${entry.key.remain}</td>
