...
import store.exception.FindProductByIdException;
...
public class ProductService {
	...
	//返回<类别，销售量>
	public HashMap<String, Double> getCateStatistic() {
		// TODO Auto-generated method stub
		HashMap<String, Double> cateList= null;
		try {
			cateList = dao.getCateStatistic();
		} catch (SQLException e) {
			throw new RuntimeException("后台获取各类别销售量失败！");
		}
		return cateList;
	}
	public HashMap<String, Double> getDayStatistic() {
		// TODO Auto-generated method stub
		HashMap<String, Double> dayList= null;
		try {
			dayList = dao.getDayStatistic();
		} catch (SQLException e) {
			throw new RuntimeException("后台获取最近一个月销售量失败！");
		}
		return dayList;
	}
}
